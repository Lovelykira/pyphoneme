...
class JSONExport:
    ...
    def __init__(self, data, file_name=None):
        self.data = data
        self.file_name = file_name or 'reports/synthesis_by_{}_{}_{}.json'.format(data['mode'], data['synthesis_mode'], datetime.now())
...
class SpreadsheetExport:
    def __init__(self, data, file_name=None):
        self.data = data
        self.file_name = file_name or 'reports/synthesis_by_{}_{}_{}.xlsx'.format(data['mode'], data['synthesis_mode'], datetime.now())
